 ...
 *
 * verified:
 * - https://atcoder.jp/contests/typical90/submissions/31951624
 *
 * note:
 * - 遅延セグ木を使う
 *
...
package contests.typical90.typical90_03.typical90_029;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    LazySegTree<Integer, Integer> lazy =
        new LazySegTree<>(w, Math::max, 0, Main::mapping, Main::composition, INF);
    PrintWriter pw = new PrintWriter(System.out);
    for (int i = 0; i < n; i++) {
      int l = Integer.parseInt(sc.next()) - 1;
      int r = Integer.parseInt(sc.next());
      int height = lazy.prod(l, r) + 1;
      pw.println(height);
      lazy.apply(l, r, height);
    }
    pw.close();
    sc.close();
  }

  static Integer mapping(Integer f, Integer s) {
    return f == INF ? s : f;
  }

  static Integer composition(Integer f1, Integer f2) {
    return f1 == INF ? f2 : f1;
  }
