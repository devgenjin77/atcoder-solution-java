...
class MainTest {
  ...
  final static String category = "COMPANY";
  final static String contest = "ZONE2021";
  ...
  void testMain(String fileName) throws Exception {
    try (
      ...
      assertEquals(expectedValue, Double.parseDouble(byteArrayOutputStream.toString().trim()), 0.001);
    }
  }
